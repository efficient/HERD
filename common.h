...
#define USE_UC 1
#define USE_INLINE 1			// Disable if VALUE_SIZE > 176 bytes
...
#define WS_SERVER 64	// Change to 64 for small values
#define WS_SERVER_ 63
/******************************************************************/

#define CL_BTCH_SZ 128			//Client RECV batch size
#define CL_BTCH_SZ_ 127

#define CL_SEMI_BTCH_SZ 64			//Client RECV batch size
...
/* SHM / HUGEPAGE KEYS
 * The request area at server machines is shared among all server processes
 * The lossy index and the circular log use hugepages
 */
...
// Invalid slots have their HSB set to 1.
...
struct ctrl_blk {
	...
	struct qp_attr *local_dgram_qp_attrs;
